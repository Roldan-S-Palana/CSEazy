...
export default function Subjects() {
  ...
  return (
    <div className="flex w-full h-full bg-gray-50 dark:bg-gray-900">
      ...
      {isMobile && (
        <div className="fixed bottom-0 left-0 right-0 bg-theme-100 dark:bg-theme-900 border-t-2 border-gray-200 dark:border-gray-700 flex justify-around py-2 z-50 overflow-x-auto">
          {subjects.map((subj) => (
            <button
              key={subj._id}
